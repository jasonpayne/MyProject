 ...
 */
@Configuration
@MapperScan(basePackages = "com.xinchao.dao.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
public class DataBaseConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.xinchao.dao.enetity");
        PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources(
                "classpath:com/xinchao/dao/mapper/*.xml"
        ));
